...
const plans = [
    ...
    },
    {
        ...
        features: [
            ...
            { text: "15 kendaraan / aset", ok: true },
            { text: "15 user seat", ok: true },
    ...
    },
    {
        ...
        features: [
            ...
            { text: "80 kendaraan / aset", ok: true },
            { text: "80 user seat", ok: true },
...
const tableFeatures = [
    { label: "Jumlah aset", values: ["3", "15", "80", "∞"] },
    { label: "Jumlah user/seat", values: ["3", "15", "80", "∞"] },
    ...
    { label: "Anomaly detection", values: ["—", "-", "-", "Full"] },
                    ...
                    <span className={`mt-0.5 flex-shrink-0 w-3.5 h-3.5 rounded-full flex items-center justify-center ${
                      ...
                      {f.ok ? (
                          ...
                          <svg width="7" height="7" viewBox="0 0 7 7" fill="none">
                            ...
                            <button
                                onClick={() => router.push(`/kyc?plan=${plan.id}`)}
                                className={`block w-full text-center font-ui text-sm py-2.5 rounded-xl transition-all duration-200 ${plan.ctaStyle}`}
                            >
                                {plan.cta}
                            </button>
                        </div>
